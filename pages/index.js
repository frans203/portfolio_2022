      ...
      <div className='overflow-hidden flex flex-col items-start justify-center md:flex-row'>
        <div className='space-y-12 w-full md:w-3/5 align-top text-center lg:text-left'>
          <div className='space-y-5'>
            <p className='font-[Raleway]  relative text-lg lg:text-2xl text-gray-200 ' >
            I like programming since I was a teenager, but just in the end of the High School I started to study and delve into the I.T area, becoming a {" "}
            <strong>Frond-End Developer</strong>.
            I have 
            {" "}
            <span 
              className=' transform span_about hover:bg-red-500 transition-all duration-300 
              hover:scale-90 '>
            ...
            <span 
              className='span_about hover:bg-green-500 transition-all duration-300 '>
                Solving Problems and Conflicts
            </span> and I'm always looking for my 
            {" "}

            <span 
              className='span_about hover:bg-purple-500 transition-all duration-300 '>
                Personal Development
            </span> both professionally and socially.
            </p>

            <p className='font-[Raleway]  relative text-lg lg:text-2xl text-gray-200'>
            In the field of technology, I always seek to create projects  and delve into the most used languages ​​in the job market.
          ...
          <div className='mt-12 flex flex-col items-center justify-center'>
            <h3 className='font-[Raleway]  relative text-md lg:text-lg text-gray-200 font-bold'>See What Clients Are Saying</h3>
          <h3 className='text-white text-lg text-center '>“Francisco is an excellent freelancer, very quick to complete tasks, and he a very good communicator.”
            <br/>
